...
import AssetHeaderValue from "./AssetHeaderValue";
          ...
          title: (
            <>
              <div className="flex flex-1 flex-wrap items-center justify-between gap-4">
                <div className="flex max-w-full grow basis-[70%] flex-wrap gap-2 md:min-w-[300px]">
                  <div className="flex items-center gap-2">
                    <span
                      ...
                      style={{ backgroundColor: colorOf(outcomeName) }}
                    />
                ...
                {/* The live PD, so a No To All drag is visible on every card in
                    the open group without expanding any of them. */}
                <div className="flex items-center gap-3">
                  <AssetHeaderValue outcome={outcome} />
                  {isSelected ? (
          ...
          body: (
            <div className="flex w-full flex-col">
              ...
              <div className="pt-6 pb-4">
                <PredictionSlider outcome={outcome} />
              </div>
              {tradeExecutor ? (
